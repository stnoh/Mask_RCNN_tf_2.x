...
[Notice] : [The original mask-rcnn](https://github.com/matterport/Mask_RCNN) uses the tensorflow 1.X version. I modified it for tensorflow >= 2.6 version.
...
- CUDA : 11.7
- Tensorflow : 2.6.0
- Keras : 2.6.0 (tensorflow backend)
- Python 3.9

Also certificated in Google Colab (tensorflow 2.12.0).
